      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                style={{ display: "flex", alignItems: "center", gap: hp(1) }}
              >
                <Clock size={hp(2)} />
                <span>8 weeks</span>
              </div>
        ...
        >
          ...
          >
            ...
            <span>
              {item.lessons.filter((l) => l.finished).length}/
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: hp(2) }}>
            {item.lessons.map((lesson, index) => (
              <motion.div
                ...
                style={{
                  backgroundColor: lesson.finished
                    ? `${colors.success}10`
                    : colors.card,
                  padding: hp(2),
                  borderRadius: hp(1.5),
                  ...
                  border: `1px solid ${
                    lesson.finished ? colors.success + "30" : colors.border
                  }`,
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderRadius: "50%",
                        border: `2px solid ${
                          lesson.finished ? colors.success : colors.error
                        }30`,
                        display: "flex",
                        alignItems: "center",
                  ...
                  >
                    ...
                    <span>
                      {lesson.finishedVideos}/{lesson.videos} videos
                    </span>
                  </div>
                </div>
                <p
                ...
                >
                  Secrets of money, currency and our financial evolution
                </p>
              </motion.div>
            ))}
          </div>
